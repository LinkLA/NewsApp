...
public class com_news_newsapp_NewRealmProxy extends New
    implements RealmObjectProxy, com_news_newsapp_NewRealmProxyInterface {
    ...
    private ProxyState<New> proxyState;

    com_news_newsapp_NewRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<New>(this);
    ...
    @SuppressWarnings("cast")
    public static New createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        New obj = null;
        if (update) {
            Table table = realm.getTable(New.class);
            NewColumnInfo columnInfo = (NewColumnInfo) realm.getSchema().getColumnInfo(New.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(New.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_news_newsapp_NewRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.com_news_newsapp_NewRealmProxy) realm.createObjectInternal(New.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_news_newsapp_NewRealmProxy) realm.createObjectInternal(New.class, json.getInt("id"), true, excludeFields);
                }
            } else {
        ...
        final com_news_newsapp_NewRealmProxyInterface objProxy = (com_news_newsapp_NewRealmProxyInterface) obj;
        if (json.has("author")) {
    ...
    public static New createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final New obj = new New();
        final com_news_newsapp_NewRealmProxyInterface objProxy = (com_news_newsapp_NewRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static New copyOrUpdate(Realm realm, New object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (New) cachedRealmObject;
        }

        New realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(New.class);
            NewColumnInfo columnInfo = (NewColumnInfo) realm.getSchema().getColumnInfo(New.class);
            long pkColumnIndex = columnInfo.idIndex;
            long rowIndex = table.findFirstLong(pkColumnIndex, ((com_news_newsapp_NewRealmProxyInterface) object).realmGet$id());
            if (rowIndex == Table.NO_MATCH) {
                canUpdate = false;
            } else {
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(New.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_news_newsapp_NewRealmProxy();
    ...
    public static New copy(Realm realm, New newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        New realmObject = realm.createObjectInternal(New.class, ((com_news_newsapp_NewRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_news_newsapp_NewRealmProxyInterface realmObjectSource = (com_news_newsapp_NewRealmProxyInterface) newObject;
        com_news_newsapp_NewRealmProxyInterface realmObjectCopy = (com_news_newsapp_NewRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, New object, Map<RealmModel,Long> cache) {
        ...
        long pkColumnIndex = columnInfo.idIndex;
        long rowIndex = Table.NO_MATCH;
        Object primaryKeyValue = ((com_news_newsapp_NewRealmProxyInterface) object).realmGet$id();
        if (primaryKeyValue != null) {
            rowIndex = Table.nativeFindFirstInt(tableNativePtr, pkColumnIndex, ((com_news_newsapp_NewRealmProxyInterface) object).realmGet$id());
        }
        if (rowIndex == Table.NO_MATCH) {
            rowIndex = OsObject.createRowWithPrimaryKey(table, pkColumnIndex, ((com_news_newsapp_NewRealmProxyInterface) object).realmGet$id());
        } else {
            Table.throwDuplicatePrimaryKeyException(primaryKeyValue);
        }
        cache.put(object, rowIndex);
        String realmGet$author = ((com_news_newsapp_NewRealmProxyInterface) object).realmGet$author();
        if (realmGet$author != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.authorIndex, rowIndex, realmGet$author, false);
        }
        String realmGet$title = ((com_news_newsapp_NewRealmProxyInterface) object).realmGet$title();
        if (realmGet$title != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.titleIndex, rowIndex, realmGet$title, false);
        }
        String realmGet$description = ((com_news_newsapp_NewRealmProxyInterface) object).realmGet$description();
        if (realmGet$description != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.descriptionIndex, rowIndex, realmGet$description, false);
        }
        String realmGet$url = ((com_news_newsapp_NewRealmProxyInterface) object).realmGet$url();
        if (realmGet$url != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.urlIndex, rowIndex, realmGet$url, false);
        }
        java.util.Date realmGet$publishedTime = ((com_news_newsapp_NewRealmProxyInterface) object).realmGet$publishedTime();
        ...
        String realmGet$urlToImage = ((com_news_newsapp_NewRealmProxyInterface) object).realmGet$urlToImage();
        ...
        String realmGet$source = ((com_news_newsapp_NewRealmProxyInterface) object).realmGet$source();
    ...
    public static long insertOrUpdate(Realm realm, New object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(New.class);
    ...
    public static New createDetachedCopy(New realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        ...
        if (cachedObject == null) {
            ...
            unmanagedObject = (New) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_news_newsapp_NewRealmProxyInterface unmanagedCopy = (com_news_newsapp_NewRealmProxyInterface) unmanagedObject;
        com_news_newsapp_NewRealmProxyInterface realmSource = (com_news_newsapp_NewRealmProxyInterface) realmObject;
    ...
    static New update(Realm realm, New realmObject, New newObject, Map<RealmModel, RealmObjectProxy> cache) {
        com_news_newsapp_NewRealmProxyInterface realmObjectTarget = (com_news_newsapp_NewRealmProxyInterface) realmObject;
        com_news_newsapp_NewRealmProxyInterface realmObjectSource = (com_news_newsapp_NewRealmProxyInterface) newObject;
    ...
    public boolean equals(Object o) {
        ...
        com_news_newsapp_NewRealmProxy aNew = (com_news_newsapp_NewRealmProxy)o;
